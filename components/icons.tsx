...
export const Icons = {
  logo: (props: LucideProps) => (
    <svg {...props} viewBox="0 0 512 512">
      <g>
        <path d="M105.67 56.012c24.601 24.601 41.244 81.13 16.643 105.731s-81.13 7.958-105.731-16.643-20.623-60.509 3.978-85.11 60.509-28.579 85.11-3.978z" fill="#60a5fa" data-original="#abdfeb" opacity="1"></path>
        <path d="M111.097 169.375c-9.754-53.933-61.535-93.098-102.131-94.531-13.495 22.793-12.381 50.26 7.615 70.256 21.368 21.367 66.817 36.724 94.516 24.275z" fill="#558ce7" data-original="#8bcdd8" opacity="1"></path>
        <path d="M406.33 56.012c-24.601 24.601-41.244 81.13-16.643 105.731s81.13 7.958 105.731-16.643 20.623-60.509-3.978-85.11-60.509-28.579-85.11-3.978z" fill="#60a5fa" data-original="#abdfeb" opacity="1"></path>
        <path d="M400.903 169.375c9.754-53.933 61.535-93.098 102.13-94.531 13.495 22.793 12.381 50.26-7.615 70.256-21.367 21.367-66.816 36.724-94.515 24.275z" fill="#558ce7" data-original="#8bcdd8" opacity="1"></path>

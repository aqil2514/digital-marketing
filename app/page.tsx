...
const perks = [
  ...
  },
  {
    name: "For the Planet",
    Icon: Leaf,
    description: "We've pledge 1% of sales the preservation and restoration of the natural environment",
  },
];
    ...
    <>
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          <h1 className="sm:text-6xl text-4xl font-bold tracking-tight text-gray-950">
            Your marketplace for high-quality <span className="text-blue-600">digital assets</span>.
          </h1>
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">Welcome to DigitalHippo. Every assets on our platform is verified by our team to ensure our highest quality standards.</p>
          <div className="flex flex-col sm:flex-row gap-4 mt-6">
            <Link href="/products" className={buttonVariants()}>
              Browse Trending
            </Link>
            <Button variant={"ghost"}>Our quality promies &rarr;</Button>
          </div>
        </div>
